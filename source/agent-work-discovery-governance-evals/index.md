...
Track sources that show agents becoming delegated work units with discovery, registry, identity, authorization, and evaluation layers.
...
- [LangChain - Running untrusted agent code](https://www.langchain.com/blog/running-untrusted-agent-code-without-a-sandbox)
...
- ARD or Agent Card adoption
- enterprise agent inventory and governance
- agent identity and delegated authorization
- task horizon metrics
- digital-world or simulation-based eval
