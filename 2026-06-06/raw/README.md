...
지금까지 실제 조사에 사용한 전체 외부 링크 카탈로그는 `index.html#references`와 `2026-06-06/raw/index.md`의 Source Catalog에 주제별로 둔다. 개별 보고서의 근거 링크는 관련 요약 바로 아래에 붙인다.
...
- `2026-06-06/AI_Platform_Service_Applicability.html`: 2026-06-06 AI 플랫폼 및 서비스 적용 포인트
...
- `2026-06-06/raw/AI_Platform_Service_Applicability.md`: AI 플랫폼 및 서비스 적용 raw 원본
