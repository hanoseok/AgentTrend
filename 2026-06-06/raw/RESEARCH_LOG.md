...
| --- | --- | --- | --- | --- |
| 2026-06-28 | 0700 Agent Trend Brief | Daily Brief, agent work / discovery / governance / eval | OpenAI Codex work 데이터, Anthropic Claude Code expertise, Google ARD, GitHub Agent Finder, Microsoft Agent 365, Patronus digital world models, NIST identity/authorization, LangGraph 1.0을 확인하고 agent가 위임 가능한 작업 단위와 운영/거버넌스 레이어로 이동하는 흐름을 정리 | `2026-06-28/0700_agent_trend_brief.html`, `2026-06-28/raw/0700_agent_trend_brief.md` |
| 2026-06-11 | AI Agent 사용 분야 수동 브리프 | Manual Brief, 사용 분야 / adoption benchmark | 사람들이 AI Agent를 어느 분야에 가장 많이 사용하는지 최신 survey와 제품 신호로 정리. 고객지원/컨택센터, 리서치/데이터 분석, 개인 생산성/내부 워크플로, IT/개발/보안, 세일즈/마케팅, back-office/R&D/공급망 순으로 해석하고 AI 플랫폼 공통 기능을 도출 | `2026-06-11/1103_agent_trend_manual.html`, `2026-06-11/raw/1103_agent_trend_manual.md` |
