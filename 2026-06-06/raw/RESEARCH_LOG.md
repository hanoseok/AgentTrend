...
| --- | --- | --- | --- | --- |
| 2026-06-07 | Claude Code Dynamic Workflows / ultracode | Deep Dive, Agent runtime / orchestration | dynamic workflow code 생성, subagent 병렬 실행, checkpoint, verifier, cost cap, human approval을 workflow runtime 요구사항으로 정리 | `2026-06-07/Claude_Code_Dynamic_Workflows_Deep_Dive.html`, `2026-06-07/raw/Claude_Code_Dynamic_Workflows_Deep_Dive.md` |
| 2026-06-07 | AgentBound | Deep Dive, MCP permission boundary | MCP server access control, AgentManifest, policy vocabulary, runtime enforcement, risk tier, approval policy, audit schema를 AI 플랫폼 설계 관점으로 정리 | `2026-06-07/AgentBound_Deep_Dive.html`, `2026-06-07/raw/AgentBound_Deep_Dive.md` |
| 2026-06-07 | SWE-Skills-Bench | Deep Dive, Skill eval benchmark | public SWE skills의 marginal utility, pass-rate delta, token overhead, version mismatch, skill marketplace의 eval-first 설계 원칙을 정리 | `2026-06-07/SWE_Skills_Bench_Deep_Dive.html`, `2026-06-07/raw/SWE_Skills_Bench_Deep_Dive.md` |
| 2026-06-07 | COLLEAGUE.SKILL | Deep Dive, Trace-to-skill / expert skill | human/role trace를 versioned skill package로 distill하는 흐름, capability track, bounded behavior track, privacy/consent/IP/governance 리스크를 정리 | `2026-06-07/COLLEAGUE_SKILL_Deep_Dive.html`, `2026-06-07/raw/COLLEAGUE_SKILL_Deep_Dive.md` |
| 2026-06-07 | Hermes Agent | Deep Dive, Open-source persistent agent | memory, skills, messaging gateway, MCP, cron/webhook, provider routing을 묶은 persistent personal agent 제품 패턴과 tool/skill bloat, permission risk를 정리 | `2026-06-07/Hermes_Agent_Deep_Dive.html`, `2026-06-07/raw/Hermes_Agent_Deep_Dive.md` |
| 2026-06-07 | SkillNet | Deep Dive, Skill infrastructure / graph | skill repository, ontology, graph, auto-create pipeline, 5-D evaluation, SWE-Skills-Bench와 결합한 measured utility 중심 skill platform 설계를 정리 | `2026-06-07/SkillNet_Deep_Dive.html`, `2026-06-07/raw/SkillNet_Deep_Dive.md` |
...
| 2026-06-06 | AP2 / Agent Payments Protocol | Deep Dive, Agent payment trust layer | Checkout Mandate, Payment Mandate, Verifiable Digital Credential, Trusted Surface, human-present/human-not-present 결제 위임, FIDO 표준화 흐름, 결제 서비스 agent 결제 승인/감사/분쟁 증거 설계 | `2026-06-06/AP2_Deep_Dive.html`, `2026-06-06/raw/AP2_Deep_Dive.md` |
