...
- HTML 정본: `report/selected-agent-project-paper-overview/`

## 0. 개별 딥다이브

이 문서는 전체 우선순위와 연결 구조를 보는 개요다. 상세 딥다이브는 2026-06-07 개별 문서에서 각각 관리한다.

- `report/claude-code-dynamic-workflows/`, `history/2026-06-07/Claude_Code_Dynamic_Workflows_Deep_Dive.md`
- `report/agentbound-deep-dive/`, `history/2026-06-07/AgentBound_Deep_Dive.md`
- `report/swe-skills-bench-deep-dive/`, `history/2026-06-07/SWE_Skills_Bench_Deep_Dive.md`
- `report/colleague-skill-deep-dive/`, `history/2026-06-07/COLLEAGUE_SKILL_Deep_Dive.md`
- `report/hermes-agent-deep-dive/`, `history/2026-06-07/Hermes_Agent_Deep_Dive.md`
- `report/skillnet-deep-dive/`, `history/2026-06-07/SkillNet_Deep_Dive.md`
...
- [Agent Trend Scout](../../report/agent-trend-scout/index.html)
