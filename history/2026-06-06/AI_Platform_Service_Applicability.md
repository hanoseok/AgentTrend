...
- HTML 정본: `report/ai-platform-service-applicability/`
- 범위: 특정 회사명 제외. AI 플랫폼 및 사용자-facing 서비스에서 사용할 수 있는 점 중심.

## 1. Executive Summary

참고 링크: [Selected Deep Dive](../../report/selected-agent-project-paper-overview/index.html), [A2A Deep Dive](../../report/a2a-deep-dive/index.html), [UCP Deep Dive](../../report/ucp-deep-dive/index.html), [AP2 Deep Dive](../../report/ap2-deep-dive/index.html), [AG-UI Deep Dive](../../report/ag-ui-deep-dive/index.html), [A2-UI Deep Dive](../../report/a2-ui-deep-dive/index.html)
...
- [A2A Deep Dive](../../report/a2a-deep-dive/index.html)
- [UCP Deep Dive](../../report/ucp-deep-dive/index.html)
- [AP2 Deep Dive](../../report/ap2-deep-dive/index.html)
- [AG-UI Deep Dive](../../report/ag-ui-deep-dive/index.html)
- [A2-UI Deep Dive](../../report/a2-ui-deep-dive/index.html)
- [Selected Overview](../../report/selected-agent-project-paper-overview/index.html)
